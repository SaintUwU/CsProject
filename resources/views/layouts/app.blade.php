...
<head>
    ...
    <title>AutoProvenance: The Maintenance History System -</title>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            @canany(['create-product', 'edit-product', 'delete-product'])
                                <li><a class="nav-link" href="{{ route('cars.index') }}">Manage Products</a></li>
                            @endcanany
            ...
            <div class="container">
                <div class="row justify-content-center mt-3">
                    <div class="col-md-12">
                        ...
                        <h3 class="text-center mt-3 mb-3">AutoProvenance  <a href="https://www.allphptricks.com/"></a></h3>
                        @yield('content')
